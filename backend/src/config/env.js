...
const env = {
  ...
  mongoUri: process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/hstockhub',
  sessionSecret: process.env.SESSION_SECRET || 'dev-only-change-this-session-secret',
  cookieName: process.env.COOKIE_NAME || 'hstockhub.sid',
  csrfCookieName: process.env.CSRF_COOKIE_NAME || 'hstockhub.csrf',
  ...
  frontendDir: path.resolve(__dirname, '..', '..', '..', 'hstockhub.com')
};
